...
function implementFilter(idealRadius, butterRadius, butterOrder, gaussRadius, type){      
  ...
  //Lấy kết quả 3 ảnh sau khi lọc
  let idealResult = takeResult(complexImg, idealFilter,P,Q);
  let butterResult = takeResult(complexImg, butterFilter,P,Q);
  let gaussResult = takeResult(complexImg, gaussFilter,P,Q);
